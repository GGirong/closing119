...
<br>
개인정보 보유 및 이용기간<br>
-개인정보는 수집 및 이용 목적 달성 시까지 보유하며, 이용목적 달성 후 파기하는 것을 원칙으로함
                            </div>
                            <div style="height: 10px;"></div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="customRadioInline1" name="customRadioInline1" value="Yes" class="custom-control-input" v-model="privacy">
                                <label class="custom-control-label" for="customRadioInline1">동의합니다.</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                 <input type="radio" id="customRadioInline2" name="customRadioInline1" value="No" class="custom-control-input" v-model="privacy">
                                <label class="custom-control-label" for="customRadioInline2">동의하지 않습니다.</label>
                            </div>
                            <div v-if="privacy=='No'" class="password-validation">개인정보수집에 동의하셔야 파트너스 등록이 가능합니다.</div>
                            ...
                            <div style="height: 20px;"></div>
                                ...
                                <div style="height: 20px;"></div>
                                    <div class="row row-10">
                                        ...
                                        <div class="col-md-3 col-12  section-space--bottom--20" v-if="!idConfirmed">
                                            <input class="form-control" name="up" type="text" placeholder="" v-model="partnersData.username">
                                        </div>
                                        <div class="col-md-3 col-12  section-space--bottom--20" v-if="idConfirmed">
                                            <input class="form-control" name="up" type="text" placeholder="" readonly v-model="partnersData.username">
                                        </div>
                                        <div class="col-md-2 col-12  section-space--bottom--20">
                                            <button style="margin-top:0px;" @click="idCheck">중복확인</button>
                                        </div>
                                        <div class="line"></div>
                                        <div class="input-title col-md-4 col-12  section-space--bottom--20">
                                            비밀번호
                                        ...
                                        <div class="col-md-4 col-12  section-space--bottom--20">
                                            ...
                                            <div v-if="passwordCheck && partnersData.password != passwordCheck" class="password-validation">비밀번호 확인이 일치하지 않습니다.</div>
                                        </div>
