                        ...
                        <div class="col-lg-12"> 
                            <div class="project-item-wrapper section-space--bottom--40">
                                <div style="border: 1px solid #d4d4d4; padding: 25px">
                                    <div style="font-size:24px; font-weight:500; margin-bottom:15px">{{ clientData.client_name}}님의 견적 요청서</div>
                                    <div style="margin-left:15px">연락처: <span style="margin-left:45px">{{ clientData.phone_num}}</span></div>
                                    <div style="margin-left:15px">상호: <span style="margin-left:45px">{{ clientData.business_name}}</span></div>
                                    <div style="margin-left:15px">주소: <span style="margin-left:45px">{{ clientData.address}}</span></div>
                                    <div style="margin-left:15px">평수: <span style="margin-left:45px">{{ clientData.py}}</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
