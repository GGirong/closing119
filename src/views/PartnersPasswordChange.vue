          ...
          <div class="row row-10">
            ...
            >
              <input
                ...
                type="password"
                placeholder=""
                v-model="passwordData.now_password"
              />
            </div>
            ...
            <div class="col-md-4 col-12  section-space--bottom--20">
              ...
              <div
                v-if="
                  passwordCheck && passwordData.new_password != passwordCheck
                "
  ...
  methods: {
    async changePassword() {
      if (this.find) {
        ...
        axios
          .post("https://new-api.closing119.com/api/nologinpw/", partnerData)
          .then((res) => {
            alert(
              "정상적으로 변경되었습니다. 바뀐 비밀번호로 다시 로그인 해주세요!"
            );
        ...
        axios
          .post("https://new-api.closing119.com/api/login/", loginData)
          .then((res) => {
            var partnerData = {};
            partnerData.password = this.passwordData.new_password;
            ...
            axios
              .patch(
                "https://new-api.closing119.com/api/partner/" +
                  this.getPartner +
                  "/",
                partnerData
              )
