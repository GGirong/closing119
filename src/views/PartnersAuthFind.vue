            ...
            <div class="container">
                <div class="contact-form">
                    <div class="row row-10">
                        ...
                        <div v-if="findingId" class="input-title col-md-4 col-12  section-space--bottom--20">
                            해당 이메일로 가입한 아이디
                        </div>
                        <div v-if="findingId" class="col-md-4 col-12  section-space--bottom--20">
                        ...
                        <div v-if="findingPw" class="col-md-4 col-12  section-space--bottom--20">
...
<script>
    ...
    export default {
        ...
        methods: {
            async idFind() {
                await axios.post('http://tmdgud1112.pythonanywhere.com/api/recoveryid/', this.idData).then(res=>{
                    this.findingId = true
            ...
            async pwFind() {
                await axios.post('http://tmdgud1112.pythonanywhere.com/api/recoverypw/', this.pwData).then(res=>{
            ...
            async changePw() {
                ...
                await axios.post('http://tmdgud1112.pythonanywhere.com/api/recoverycheck/', checkData).then(res=>{
